...
def main(args, model):
    ...
    data_loader = InferenceDataLoader(args.events_file_path, dataset_kwargs=dataset_kwargs, ltype=args.loader_type, real_data=args.real_data, direction=args.direction)
    ...
    for item in tqdm(data_loader):
        ...
        if args.is_flow:
            ...
            cv2.imwrite(join(output_folder, iad_name), iad)
