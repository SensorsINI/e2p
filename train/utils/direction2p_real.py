...
method = 'firenet'
i90_root = './output_real/{}_90'.format(method)
i45_root = './output_real/{}_45'.format(method)
i135_root = './output_real/{}_135'.format(method)
i0_root = './output_real/{}_0'.format(method)

iad_root = './output_real/{}_direction_iad'.format(method)
